...
**目标**：3 句话内抓住读者，并在前 3000-4000 字完成不可逆伤害。**必须包含一个开篇钩子**（优先从 `female-revenge-longform-pipeline.md` 的背叛烈度图谱和 hooks-chapter.md 选择类型）。

**技法指令**：前 100 字事件密度 ≥ 3，不做背景铺垫，直接上事件链。前 2000 字内必须落地伤害事件、女主不哭不闹的反应、贯穿道具首次登场、男主微表情破绽、旁人反应。
