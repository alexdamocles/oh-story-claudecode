...
2. `设定.md` 完整，`小节大纲.md` 缺失或未列出 35-45 节规划 → 继续完成 `小节大纲.md`。
...
3. 确定揭露方式 → 同上
4. 编写 小节大纲.md（格式见 writing-workflow.md）：默认按 30000-40000 字规划 35-45 节，每节标明结构段/五段功能、预计字数、人物/关系变化、因果/逻辑链、结尾承接/钩子
