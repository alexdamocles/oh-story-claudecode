...
5. **编写 小节大纲.md**：每节 1 行，格式如下：
   `结构段/五段功能 | 主事件 | 女主主动选择 | 对手/规则反制 | 本节代价 | 状态变化 | 子事件×3-5 | 情绪 | 人物/关系变化 | 因果/逻辑链 | 读者新获知什么 | 结尾承接/钩子 | 伏笔/物件 | 动静 | 对话密度 | 目标字数`
