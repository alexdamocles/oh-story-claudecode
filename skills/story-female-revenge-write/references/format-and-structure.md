...
- **用户明确指定 8000-20000 字短篇模式时**：每小节 800-1500 字，爽文可压缩至 500-800 字/节（见 genre-writing-formulas.md）；通常用 8-15 节，具体按目标总字数反推
- 两套字数口径不得混用；未明确指定短篇模式时，`story-female-revenge-write` 按默认 4.2 万字模式执行
- 每小节推进一个明确的情节点
